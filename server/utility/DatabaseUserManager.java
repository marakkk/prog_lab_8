...
public class DatabaseUserManager {
    ...
    public boolean checkUserByUsernameAndPassword(User user) throws DatabaseHandlingException {
        ...
        try {
            ...
            preparedSelectUserByUsernameAndPasswordStatement.setString(1, user.username());
            preparedSelectUserByUsernameAndPasswordStatement.setString(2, user.username()
            );
    ...
    public int getUserIdByUsername(User user) throws DatabaseHandlingException {
        ...
        try {
            ...
            preparedSelectUserByUsernameStatement.setString(1,  user.username()
            );
            ResultSet resultSet = preparedSelectUserByUsernameStatement.executeQuery();
            logger.debug("Request is completed: SELECT_USER_BY_USERNAME.");
            if (resultSet.next()) {
    ...
    public boolean insertUser(User user) throws DatabaseHandlingException {
        ...
        try {
            ...
            preparedInsertUserStatement.setString(1,                     user.username()
            );
            preparedInsertUserStatement.setString(2, user.username()
            );
