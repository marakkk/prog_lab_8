...
public class AddIfMinAction extends Action{
    public AddIfMinAction(User user, ClientManager client, GuiManager guiManager) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(result == OK_OPTION){
            ...
            try {
                response = client.processRequestToServer(new ClientRequest("add_if_max", "", ticket, user,  GuiManager.getLocale()));
